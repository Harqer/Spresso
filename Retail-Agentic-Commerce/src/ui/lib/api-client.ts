...
const API_URL = isServer
  ? process.env.MERCHANT_API_URL || "https://***REDACTED_PROJECT_ID***.web.app/api/proxy/merchant"
  : "/api/proxy/merchant";

const PSP_URL = isServer ? process.env.PSP_API_URL || "https://***REDACTED_PROJECT_ID***.web.app/api/proxy/psp" : "/api/proxy/psp";
