...
# Backend Rate Limiting: Protects AI and Transaction endpoints
app.add_middleware(RedisRateLimitMiddleware, limit=100, window=60)

# Zero-Trust Network Isolation: Must be applied early in the stack
