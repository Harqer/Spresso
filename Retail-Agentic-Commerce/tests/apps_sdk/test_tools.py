...
# Expert Strategy: Real-Service Testing Switch
# Set LIVE_INTEGRATION_TEST=true in CI to disable mocks and test real features.
USE_MOCKS = os.getenv("LIVE_INTEGRATION_TEST", "false").lower() != "true"
...
class TestSearchProducts:
    ...
    async def test_returns_products_and_metadata(self) -> None:
        ...
        if USE_MOCKS:
            ...
            # Expert Strategy: Test the real feature with real Gemini/Milvus
            result = await search_products(query="tee")
